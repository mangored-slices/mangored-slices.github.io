...
define('view.entry', function() {
  ...
  return EntryView = (function(_super) {
    ...
    */
    ...
    EntryView.prototype.text = function() {
      var $el, body, st, title;
      st = _.str.stripTags;
      title = this.entry.get('text');
      body = this.entry.get('fulltext');
...
define('view.entry_dialog', function() {
  ...
  return EntryDialogView = (function() {
    ...
    EntryDialogView.prototype.render = function() {
      ...
      this.$el.find(r('date')).text(this.model.date('ago')).attr('href', this.model.get('url') || this.model.get('image'));
...
$(function() {
  ...
  return Data.accounts = new (require('collection.accounts'));
});
...
$(function() {
  ...
  return App.menuView = new (require('view.menu'));
});
...
(function() {
  return setTimeout(function() {
    if (!$('html').is('.wf-active') && !$('html').is('.wf-inactive')) {
      return $('html').addClass('wf-inactive');
    }
  }, 10000);
})();
